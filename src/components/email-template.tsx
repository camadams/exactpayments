...
export const EmailTemplate = (billResult: EmailTemplateProps) => {
  return (
    <Tailwind>
      <div className="bg-gray-100 p-8 w-full max-w-5xl mx-auto relative">
        {/* Logo in the top right-hand corner */}
        <div className="absolute top-10 right-10 m-4 w-16 h-16">
          <Img src="/favicon.ico" alt="Company Logo" width={64} height={64} />
        </div>

        <div className="bg-white p-8 rounded-lg aspect-[1/1.41]">
